        ...
        <div class="row m-0 p-0">
            <div class="col-12 m-0 p-1">
                <ul class="list-group list-group-flush p-2">
                    ...
                    <a href="list.php"><li class="list-group-item active px-2"><i class="bi bi-ui-checks-grid me-2"></i>My surveys</li></a>
                    <hr class="mx-2 my-1">
            ...
            <div class="col-12 m-0 p-1 canvassmcontent shadow">
                <ul class="list-group list-group-flush p-2">
                    <div class="row m-0 d-flex justify-content-center align-items-center">
                        ...
                        <div class="col p-0 d-flex justify-content-center align-items-center">
                            <a  href="list.php"><li class="list-group-item d-flex justify-content-center active"><i class="bi bi-ui-checks-grid"></i></li></a>
                        </div>
                        <div class="col p-0 d-flex justify-content-center align-items-center">
