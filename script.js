        ...
        if(loginValidate()){
            ...
            xhr.onreadystatechange=function(){
                if(xhr.readyState===4&&xhr.status===200){
                    ...
                    if(response==="success"){
                        window.location.href="home/home.php?welcometoast=true";
                    }
...
if(signinform){
    signinform.addEventListener("submit",(event)=>{
        ...
        if(signinValidate()){
            ...
            xhr.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
            xhr.send('signinusernamenew='+encodeURIComponent(signinusernamenew)+'&signinfirstnamenew='+encodeURIComponent(signinfirstnamenew)+'&signinlastnamenew='+encodeURIComponent(signinlastnamenew)+'&professionnew='+encodeURIComponent(professionnew)+'&countrynew='+encodeURIComponent(countrynew)+'&signinpasswordnew='+encodeURIComponent(signinpasswordnew));
            xhr.onreadystatechange=function(){
                if(xhr.readyState===4&&xhr.status===200){
                    var response=xhr.responseText;
                    if(response==="success"){
