...
<body>
    <div class="container m-sm-5 mx-1 my-5">
        <div class="row m-0 d-flex justify-content-center align-items-center">
            <div class="col-xl-5 col-lg-6 col-md-8 col-sm-10 col-12 p-0 d-flex justify-content-center align-items-center">
                <form id="loginform" class="px-sm-5 px-4 py-3 shadow">
                    <div class="row m-0">   
                        ...
                        <div class="col-12 p-0 d-flex justify-content-center align-items-center mb-4">
                            <div class="d-flex justify-content-center align-items-center" id="titlenxt">Login</div>
                        </div>
                        ...
                        <div class="col-12 p-0 mb-5">
                            <div class="input-group input-group-relative">
                                ...
                                <label for="loginpassword" class="input-group-text login"><i style="color: #8d1dce; font-size: 22px;" class="bi bi-eye-slash-fill eye"></i></label>
                            </div>
                            <div id="loginpassworddiv" class="invalid-feedback d-block"></div>
                        </div>
                        <div class="col-12 p-0 mb-4">
                            <div class="form-floating">
                                <button type="submit" class="btn btn-lg w-100 shadow" id="loginbtn">Login</button>
                            </div>
                        </div>
                        ...
                        <div class="col-12 p-0 d-flex justify-content-center align-items-center mb-3">
                            <div class="form-floating">
                                <div>Don't have an account? <a href="signin.php" style="color: #8d1dce;"><b>Sign in</b></a></div>
                            </div>
                        </div>
                    </div>
                </form>
    ...
    <div class="mytoast d-none p-3 mb-5 mt-0 shadow" id="mytoast">
